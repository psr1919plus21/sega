...
<div class="l-page">
	...
	<div class="home_title-wrapper">
		<div class="l-wrapper">
			<h1 class="home_title">Battletoads and Double Dragon</h1>
			<h2>Пацаны и жабы бьют космонавтов, панков и женщин руками и ногами.</h2>
	...
	$(function()
	{
		function embed()
		{
			...
			if(emulator)
			{
				...
				{
					system : 'sega',
					url : 'roms/BattletoadsandDoubleDragon.gen'
				};
				var params = {};
				var attributes = {};
